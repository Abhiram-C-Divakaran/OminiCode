...
if __name__ == "__main__":
    ...
    try:
        with UserManager() as manager:
            ...
            sample_password = os.environ.get("OMINICODE_SAMPLE_PASSWORD")
            if not sample_password:
                raise ValueError("Set OMINICODE_SAMPLE_PASSWORD to run this standalone fixture")
            manager.create_user("admin", sample_password)
            manager.login("admin", sample_password)
